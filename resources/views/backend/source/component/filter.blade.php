        ...
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            ...
            <div class="action">
                <div class="uk-flex uk-flex-middle">
                    ...
                    <select name="source_catalogue_id" class="form-control mr10 setupSelect2">
                    ...
                    <a href="{{ route('source.create') }}" class="btn btn-danger"><i class="fa fa-plus mr5"></i>Thêm mới</a>
                </div>
            </div>
        </div>
    </div>
