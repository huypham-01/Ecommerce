        ...
        <div class="variant-wrapper {{ (count($variantCatalogue)) ? '' : 'hidden' }}">
            ...
            <div class="variant-body">
                @if ($variantCatalogue && count($variantCatalogue))
                    @foreach ($variantCatalogue as $keyAtt => $valAttr)
                    <div class="row mb20 variant-item">
                        ...
                        <div class="col-lg-8">
                            ...
                            <select name="attribute[{{ $valAttr }}][]" class="selectVariant variant-{{ $valAttr }} form-control" id="" multiple data-catid="{{ $valAttr }}"></select>
                        </div>
                        <div class="col-lg-1">
